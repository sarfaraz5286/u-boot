/*
 * DDR2 initialization code for MIPS32 CPU-core SPL
 *
...
int init_ddr(void)
{
	 ...
	 * not sequentially
	 */
	writel(0x00000000, TOPLEVEL_REGS + DDR_CTRL_OFFSET);
	...
	writel(0x00000000, DDR_PCTL + DDR_PCTL_TRSTH_OFFSET);
	 ...
	 */
	writel(0x00060000 | (BL8 ? 0x1 : 0x0),
		DDR_PCTL + DDR_PCTL_MCFG_OFFSET);
	 ...
	 * 31 TPD LPDDR2 0
	 */
	writel(0x0000000A, DDR_PHY + DDRPHY_DCR_OFFSET);
	 ...
	 * 31:16 Reserved
	 */
	writel(0x00000B62 | (BL8 ? 0x1 : 0x0), DDR_PHY + DDRPHY_MR_OFFSET);
	/* MR1 : EMR Register
	 * Generate to use with PHY and PCTL
	 ...
	 * 31:16 Reserved
	 */
	writel(0x00000044, DDR_PHY + DDRPHY_EMR_OFFSET);
	/* MR2 : EMR2 Register
	 * Generate to use with PHY and PCTL
	 * 2:0 PASR, NA 000
	 * 3 DDC NA 0
	 ...
	 * 31:16 Reserved
	 */
	writel(0x00000000, DDR_PHY + DDRPHY_EMR2_OFFSET);
	/* DSGCR
	 * 0 PUREN Def 1
	 * 1 BDISEN Def 1
	 * 2 ZUEN Def 1
	 ...
	 */
	writel(0xF2000927, DDR_PHY + DDRPHY_DSGCR_OFFSET);
	 ...
	 */
	writel(0x3092666E, DDR_PHY + DDRPHY_DTPR0_OFFSET);
	 ...
	 * 31:30 Reserved
	 */
	writel(0x094E0092, DDR_PHY + DDRPHY_DTPR1_OFFSET);
	 ...
	 * 32:29 Reserved
	 */
	writel(0x06418CC8, DDR_PHY + DDRPHY_DTPR2_OFFSET);
	 ...
	 */
	writel(0x05013880, DDR_PHY + DDRPHY_PTR1_OFFSET);
	...
	writel(0x000001DF, DDR_PHY + DDRPHY_PIR_OFFSET);
	...
	writel(0x00000001, DDR_PCTL + DDR_PCTL_POWCTL_OFFSET);
	...
	writel(0x00000002, DDR_PCTL + DDR_PCTL_TMRD_OFFSET);
	/*
	 ...
	 */
	writel(0x00010006, DDR_PCTL + DDR_PCTL_TRP_OFFSET);
	 ...
	 */
	writel(0x00000012, DDR_PCTL + DDR_PCTL_TRAS_OFFSET);
	/*
	 * TRC : Min. ROW cylce time
	 * Range 11 to 31: 57.5ns / 2.5ns = 23d Playing safe 24
	 */
	writel(0x00000018, DDR_PCTL + DDR_PCTL_TRC_OFFSET);
	/*
	...
	writel(0x00000003, DDR_PCTL + DDR_PCTL_TRTP_OFFSET);
	 ...
	 */
	writel(0x00000003, DDR_PCTL + DDR_PCTL_TWTR_OFFSET);
	/* TEXSR : Exit Self Refresh to first valid cmd: tXS 200*/
	writel(0x000000C8, DDR_PCTL + DDR_PCTL_TEXSR_OFFSET);
	/*
	 ...
	 * t_ckesr = 0 DDR2
	 */
	writel(0x00000000, DDR_PCTL + DDR_PCTL_TCKESR_OFFSET);
	 ...
	 * 30:24 Reserved
	 */
	writel(0x80100001, DDR_PCTL + DDR_PCTL_MCMD_OFFSET);
	 ...
	 */
	writel(0x00000003, DDR_PCTL + DDR_PCTL_DFISTCFG0_OFFSET);
	 ...
	 */
	writel(0x06060004, DDR_PCTL + DDR_PCTL_DFIODTCFG1_OFFSET);
	...
	if (BL8)
		...
		writel(0x000400A0, DDR_PCTL + DDR_PCTL_PCFG0_OFFSET);
